...
protocol _TableViewBuilder: class {
    ...
    var nodeProviders: [_TableViewMultiNodeProvider] { get }
    var footerSectionProviders: [_SectionPartionTableViewProvider] { get }
    var headerSectionProviders: [_SectionPartionTableViewProvider] { get }
